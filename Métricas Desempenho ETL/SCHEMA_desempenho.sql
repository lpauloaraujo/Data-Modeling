...
-- Schema tce_pb_teste
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `tce_pb_teste` ;

-- -----------------------------------------------------
-- Schema tce_pb_teste
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tce_pb_teste` ;
USE `tce_pb_teste` ;

-- -----------------------------------------------------
-- Table `tce_pb_teste`.`fornecedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`fornecedor` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`fornecedor` (
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`municipio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`municipio` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`municipio` (
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`unidade_gestora`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`unidade_gestora` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`unidade_gestora` (
  ...
  CONSTRAINT `fk_unidade_gestora_municipio`
    ...
    REFERENCES `tce_pb_teste`.`municipio` (`id_municipio`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

-- -----------------------------------------------------
-- Table `tce_pb_teste`.`licitacao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`licitacao` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`licitacao` (
  ...
  `ano_licitacao` YEAR NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_licitacao_unidade_gestora`
    ...
    REFERENCES `tce_pb_teste`.`unidade_gestora` (`id_unidade_gestora`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

-- -----------------------------------------------------
-- Table `tce_pb_teste`.`obra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`obra` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`obra` (
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`programa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`programa` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`programa` (
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`acao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`acao` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`acao` (
  ...
  CONSTRAINT `id_programa`
    ...
    REFERENCES `tce_pb_teste`.`Programa` (`id_programa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`fonte_recurso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`fonte_recurso` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`fonte_recurso` (
  ...
  `ano_fonte` CHAR(1) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`unidade_orcamentaria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`unidade_orcamentaria` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`unidade_orcamentaria` (
...
-- -----------------------------------------------------
-- Table `tce_pb_teste`.`empenho`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb_teste`.`empenho` ;

CREATE TABLE IF NOT EXISTS `tce_pb_teste`.`empenho` (
  ...
  `unidade_orcamentaria_id` INT NOT NULL,
  ...
  INDEX `fk_empenho_fonte_recurso1_idx` (`fonte_recurso_id` ASC) VISIBLE,
  INDEX `fk_empenho_unidade_orcamentaria1_idx` (`unidade_orcamentaria_id` ASC) VISIBLE,
  CONSTRAINT `fk_empenho_fornecedor`
    FOREIGN KEY (`credor_id`)
    REFERENCES `tce_pb_teste`.`fornecedor` (`id_fornecedor`),
  CONSTRAINT `fk_empenho_licitacao`
    FOREIGN KEY (`licitacao_id`)
    REFERENCES `tce_pb_teste`.`licitacao` (`id_licitacao`),
  ...
  CONSTRAINT `fk_empenho_obra1`
    FOREIGN KEY (`obra_id`)
    REFERENCES `tce_pb_teste`.`obra` (`id_obra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empenho_acao`
    FOREIGN KEY (`acao_id`)
    REFERENCES `tce_pb_teste`.`acao` (`id_acao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empenho_fonte_recurso1`
    FOREIGN KEY (`fonte_recurso_id`)
    REFERENCES `tce_pb_teste`.`fonte_recurso` (`id_fonte_recurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empenho_unidade_orcamentaria1`
    FOREIGN KEY (`unidade_orcamentaria_id`)
    REFERENCES `tce_pb_teste`.`unidade_orcamentaria` (`id_unidade_orcamentaria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
