...
-- Schema tce_pb_dw
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tce_pb_dw` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `tce_pb` ;
...
CREATE TABLE IF NOT EXISTS `tce_pb`.`acao` (
  ...
  PRIMARY KEY (`id_acao`),
  INDEX `fk_acao_programa1_idx` (`programa_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `tce_pb_dw`.`dim_fonte_recurso` (
  ...
  `codigo_fonte_recurso` VARCHAR(20) NULL DEFAULT NULL,
  `descricao_fonte_recurso` VARCHAR(255) NULL DEFAULT NULL,
  `ano_fonte` VARCHAR(10) NULL DEFAULT NULL,
  `date_to` TIMESTAMP NULL,
  `date_from` TIMESTAMP NULL,
  `version` INT(11) NULL,
