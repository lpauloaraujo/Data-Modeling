...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`fornecedor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`municipio` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`unidade_gestora` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`licitacao` ;
...
-- Table `tce_pb`.`obra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`obra` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`programa` ;
...
-- Table `tce_pb`.`acao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`acao` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`fonte_recurso` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`unidade_orcamentaria` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tce_pb`.`empenho` ;
